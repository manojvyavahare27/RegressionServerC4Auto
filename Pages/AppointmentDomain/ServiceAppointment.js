...
class ServiceAppointment
{
    ...
    constructor(page)
    {
        ...
        this.btnSearch=page.locator("xpath=//button[@data-testid='Search']")
        this.txtStartDate=page.locator("xpath=//input[@data-testid='Start Date']")
        this.txtEndDate=page.locator("xpath=//input[@data-testid='End Date']")
        this.linkAppType=page.getByRole('gridcell', { name: 'Type' }).getByTestId('Type')
